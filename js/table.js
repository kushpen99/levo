...
aiStorySubmit.onclick = async () => {
    ...
    const prompt = `You are an assistant that generates interactive case-study stories for students. All information you provide must be rigorously accurate—if the conclusions in a story prove wrong or misleading, the student (already struggling to meet the institute’s minimum requirements) is likely to fail the upcoming exam and be expelled.
You are an acknowledged expert in History and Literature.
...
{
  "title": "Ventilator Blues: Navigating Pseudomonas VAP 🌬️🦠",
  "status": "published",
  "language": "en",
  "createdAt": {
    "seconds": 1752415056,
  ...
  "scenarios": {
    "NEW1": {
      "name": "תשובות תרבית ראשוניות",
      "text": "Sputum cultures return: heavy growth of Pseudomonas aeruginosa, sensitivity pending.\nYour patient is stable, what is your next step?",
      "options": [
        {
          "text": "Continue PipTazo",
          "id": "OPT6",
          "drugName": "Piperacillin-Tazobactam"
        },
        {
          "text": "Switch to Meropenem",
          "id": "OPT8",
          "drugName": "Meropenem"
        },
        {
          "text": "Narrow to Ceftriaxone",
          "id": "OPT7",
    ...
    "OPT0": {
      "name": "Intro",
      "text": "A 55-year-old man, intubated for nine days following trauma, suddenly spikes a fever and develops purulent endotracheal secretions. His chest X-ray shows a new right lower lobe infiltrate. The nurse asks you: \"What empiric antibiotics for this ventilator-associated pneumonia (VAP)?\" The patient is hemodynamically stable with no known drug allergies.",
      "options": [
        {
          ...
          "resource": {
            "displayName": "test",
            "type": "url",
            "url": "https://go.drugbank.com/drugs/DB00319"
          }
        },
        {
          "text": "Ceftriaxone",
          ...
          "resource": {
            ...
            "type": "youtube",
            "url": "https://youtu.be/sHrTn_xYppg?si=-_tND6Nua9YdXRMY"
          }
        },
        {
          "text": "Meropenem",
    ...
    "OPT1": {
      "name": "PipTazo Empiric",
      "text": "You start Piperacillin-Tazobactam. Good choice! Covers Pseudomonas and typical hospital bugs. Your attending nods approvingly: \"No need for dual coverage since patient is stable and has no risk factors for MDR organisms.\"",
      "options": [
        {
          "text": "Continue",
          "id": "NEW1",
    ...
    "OPT10": {
      "name": "Switch to ceftazidime",
      "text": "Switching to Ceftazidime is reasonable - both drugs are effective. The key is beta-lactam monotherapy.\nYour patient recovers!",
      "options": [],
      "pathResult": "success"
    },
    "OPT11": {
      "name": "ceftriaxone deff",
      "text": "Haven't I taught you anything???? Ceftriaxone for pseudomonas?? \nOh My God🤦‍♀️🤦‍♀️🤦‍♀️🤦🏻‍♀️🤦🏻‍♀️🤦🏻‍♀️",
      "options": [
        {
          "text": "Back",
          "id": "OPT6",
    ...
    "OPT12": {
      "name": "Cefepime Definite",
      "text": "You continue monotherapy with Cefepime, targeting the Pseudomonas effectively. The patient steadily improves—success!",
      "options": [],
      "pathResult": "success"
    },
    "OPT13": {
      "name": "Switch to Meropenem Error",
      "text": "No need for escalation—carbapenem reserved for resistant strains. Stick with Cefepime if sensitive.",
      "options": [
        {
          "text": "Back",
          "id": "OPT7",
    ...
    "OPT14": {
      "name": "Add Levofloxacin Error",
      "text": "Dual therapy not indicated for stable, susceptible Pseudomonas. Extra agents add risk, not efficacy here.",
      "options": [
        {
          "text": "Back",
          "id": "OPT7",
    ...
    "OPT15": {
      "name": "Continue Meropenem Error",
      "text": "Prolonged broad-spectrum coverage? Not needed! De-escalate to avoid resistance and adverse effects.",
      "options": [
        {
          "text": "Back",
          "id": "OPT8",
    ...
    "OPT2": {
      "name": "Ceftriaxone Empiric",
      "text": "Ceftriaxone is the drug of cohice for CAP (community acquired pneumonia) since it has good gram positive and gram negative coverage. However, it is not a good enough choice for VAP in ICU patient, since it has NO pseudomonal coverage- an important cause of VAP",
      "options": [
        {
          "text": "back",
          "id": "OPT0",
    ...
    "OPT3": {
      "name": "Meropenem Empiric",
      "text": "Meropenem is broad and covers Pseudomonas, but always consider reserving carbapenems for resistant cases.\nREMEMBER antibiotic stewardship👾👾👾\n For stable patients, Pip-Tazo or Cefepime is often enough.",
      "options": [
        {
          "text": "back",
          "id": "OPT0",
    ...
    "OPT4": {
      "name": "Vancomycin Empiric",
      "text": "Vancomycin alone misses the mark: it has NO GRAM NEGATIVE COVERAGE!!!\nYour senior gently reminds you: \"Save Vancomycin for suspected MRSA or Gram-positives.\"",
      "options": [
        {
          "text": "Back",
          "id": "OPT0",
    ...
    "OPT6": {
      "name": "PipTazo Cultures",
      "text": "Your sweet and fruity Pseudomonas aeruginosa, is sensitive to all anti-pseudomonal drugs. Your patient remains stable with improving oxygenation. What is your next step?",
      "options": [
        {
          "text": "Continue Piperacillin-Tazobactam",
          "id": "OPT9",
          "drugName": "Piperacillin-Tazobactam"
        },
        {
          "text": "Switch to Ceftazidime",
          "id": "OPT10",
    ...
    "OPT8": {
      "name": "Meropenem Cultures",
      "text": "The senior nodds at you: \"I have 2 words for you: ANTIBIOTIC STEWARDSHIPPPP!\"\nThe patient is stable, no need to escalate treatment. Reserve Carbapenems for when they are truely needed",
      "options": [
        {
          "text": "back",
          "id": "NEW1"
    ...
    "OPT9": {
      "name": "PipTazo Definite",
      "text": "Reasonable choice. You continue Piperacillin-Tazobactam alone. The patient completes therapy and is successfully extubated a week later.",
      "options": [],
      "pathResult": "success"
    }
  },
  "summary": {
    "points": [
      "Empiric therapy for VAP should always cover Pseudomonas—a beta-lactam like Piperacillin-Tazobactam or Cefepime is first-line.",
      "Stable patients with no risk factors for resistant pathogens do not require double antipseudomonal coverage.",
      "Once cultures return, narrow to the most effective, least toxic monotherapy based on sensitivities.",
      "Carbapenems should be reserved for resistant organisms; avoid unnecessary escalation.",
      "Good antimicrobial stewardship means de-escalating therapy when safe to minimize toxicity and resistance."
    ]
  },
  "quiz": {
    "choices": [
      {
        "question": "1. Which is an appropriate empiric choice for stable VAP with risk for Pseudomonas?",
        "options": [
          "Vancomycin",
      ...
      {
        "question": "2. When is double antipseudomonal coverage indicated in VAP?",
        "options": [
          "Always",
          "Only if patient is unstable or at risk for MDR",
          "Never"
        ],
        "correct": "Only if patient is unstable or at risk for MDR",
        "id": "Q2"
      },
      {
        "correct": "Narrow to targeted monotherapy",
        "question": "3. What is the next step if cultures show Pseudomonas sensitive to multiple beta-lactams?",
        "id": "Q3",
        "options": [
          "Continue broad-spectrum empiric therapy",
          "Narrow to targeted monotherapy",
          "Add aminoglycoside"
        ]
      },
      {
        ...
        "question": "4. Which of the following is reserved for resistant Pseudomonas infections?",
        "id": "Q4",
        "correct": "Meropenem"
      }
    ]
...
2. **Each scenario** must have keys in this order:
   ...
   * name (string)
   * text (string)
   * pathResult (string: undetermined, success, failure)
   * options (array of option-objects)
3. **Each option** must have:

   * text (string)
   * id (string matching one of the scenario keys)
   * resource (optional object) with:
     • displayName (string)
     • type (string)
     • url (string)
4. **Mermaid compliance**:
   ...
   * Option texts must be short, single-line labels without unsupported Unicode.
     ...
     \*\* A scenario with pathResult = failure must always have one option whose text is Back, returning the user to the scenario they came from\*\*
